...
<body class="h-screen flex flex-col bg-gray-800">
    ...
    <div class="flex-grow flex items-center justify-center">
        <div class="w-full max-w-xl p-6 bg-gray-700 rounded-lg shadow-lg">
            <h1 class="text-2xl font-bold mb-6 text-white text-center">Modifier l'historique</h1>
            <form class="max-w-md mx-auto" action="{{ route('histories.update', $history->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="relative z-0 w-full mb-6 group">
                    <input value="{{ $history->full_name }}" type="text" name="full_name" id="full-name" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder="" required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input value="{{ $history->email }}" type="email" name="email" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input value="{{ $history->phone_number }}" type="tel" pattern="^[0-9]{10}$" name="phone_number" id="nuber_phone" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder="" required />
                ...
                <div class="grid md:grid-cols-2 md:gap-6 mb-6">
                    <div class="relative z-0 w-full group">
                        <input value="{{ $history->starting }}" type="datetime-local" name="starting" id="starting" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full group">
                        <input value="{{ $history->ending }}" type="datetime-local" name="ending" id="ending" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder=" "  />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input value="{{ $history->subject }}" type="text" name="subject" id="subject" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <textarea name="description" id="description" class="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 peer h-[200px]" placeholder=" " required>{{ $history->description }}</textarea>
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-600 transition focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Modifier</button>
            </form>
        </div>
    </div>
</body>
