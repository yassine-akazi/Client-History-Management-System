        ...
        <table class="min-w-full bg-gray-800 shadow-md rounded-lg overflow-hidden">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-700 border-b border-gray-600">
                    <td class="py-3 px-4">{{ $Historie->full_name }}</td>
                    <td class="py-3 px-4">{{ $Historie->email }}</td>
                    <td class="py-3 px-4">{{ $Historie->phone_number }}</td>
                    <td class="py-3 px-4">{{ $Historie->starting }}</td>
                    <td class="py-3 px-4 {{ $Historie->ending ? 'text-green-400' : 'text-red-400' }}">
                        {{ $Historie->ending ? $Historie->ending : 'Aucune date de fin' }}
                    </td>
                    <td class="py-3 px-4">{{ $Historie->subject }}</td>
                    <td class="py-3 px-4">{{ $Historie->description }}</td>
